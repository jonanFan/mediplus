...
import es.ssh.security.MessageDigest;
import es.ssh.security.RSACipher;
import es.ssh.security.RSAPrivateKey;
...
public abstract class SSH {
  ...
  public final static String VER_SSHPKG    = "v1.2.1SCP3";
