...
import es.ssh.application.MindTerm;
import es.ssh.security.KeyPair;
import es.ssh.security.SecureRandom;
import es.ssh.terminal.TerminalWin;
import es.ssh.terminal.TerminalMenuListener;
import es.ssh.terminal.TerminalMenuHandlerFull;
import es.ssh.gui.ProgressBar;
import es.ssh.util.AWTConvenience;
...
"copied to the clipboard.";
  ...
  public void keyGenerationDialog() {
    ...
    if(keyGenerationDialog == null) {
      ...
      progBar = new ProgressBar(256, 150, 20);
