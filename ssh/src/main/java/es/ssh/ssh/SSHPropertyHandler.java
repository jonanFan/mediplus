...
import es.ssh.net.SocksProxySocket;
import es.ssh.net.WebProxyTunnelSocket;
import es.ssh.terminal.*;
import es.ssh.security.*;
import es.ssh.util.EncryptedProperties;
...
public final class SSHPropertyHandler implements SSHClientUser, SSHAuthenticator, ProxyAuthenticator {
	...
	enuma = newProps.propertyNames();
	while(enuma.hasMoreElements()) {
	    name  = (String)enuma.nextElement();
	...
	String name, value;
	Enumeration enuma = defaultPropertyNames.keys();
